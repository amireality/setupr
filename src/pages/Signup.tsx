...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    const { error } = await signUp(email, password, { company_name: companyName, phone });
    setLoading(false);
          ...
          <div className="glass-card rounded-2xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Input id="company" value={companyName} onChange={(e) => setCompanyName(e.target.value)} placeholder="Optional" />
              </div>
              <div>
