...
const StoreLogin = () => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    const { error } = await lovable.auth.signInWithOAuth("google", {
      redirect_uri: window.location.origin + "/store/dashboard",
    });
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Store Sign In | Setupr Cloud Marketplace</title>
        <meta name="description" content="Sign in to your Setupr Cloud Marketplace account." />
        <link rel="canonical" href="https://setupr.com/store/login" />
      </Helmet>
      <StoreNavbar />
      <main className="pt-24 pb-16 flex items-center justify-center">
        <div className="w-full max-w-md px-4">
          <div className="bg-black border border-primary/50 shadow-[0_0_15px_hsl(var(--primary)/0.2)] rounded-2xl p-8">
            ...
            <h1 className="font-display text-2xl font-bold mb-2 text-center">Store Sign In</h1>
