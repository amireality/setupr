...
const defaultGuides = [
  { icon: "FileText", title: "Complete Guide to Starting a Business", description: "A step-by-step guide covering business registration, compliance, and digital presence for freelancers, startups, and small businesses.", link: "/guides/starting-business-india", readTime: "15 min read" },
  { icon: "Building2", title: "Business Types Explained: Sole Prop vs LLP vs Pvt Ltd", description: "Understand the differences between business structures to make the right choice for your situation.", link: "/guides/business-types", readTime: "10 min read" },
...
const GuidesIndex = () => {
  ...
  const pageSubtitle = getSetting("guides_page_subtitle", "Comprehensive, educational resources on business registration, compliance, and digital presence. Written for freelancers, consultants, and startup founders.");
  ...
  return (
    <div className="min-h-screen bg-background relative">
      <Helmet>
        <title>Business Guides for Startups & Freelancers | Setupr</title>
        <meta name="description" content="Practical guides on business registration, compliance, and digital presence for freelancers, startups, and small businesses." />
          ...
          {`
            {
              ...
              "name": "Business Guides for Startups & Freelancers | Setupr",
              "description": "Practical guides on business registration, compliance, and digital presence for freelancers, startups, and small businesses.",
