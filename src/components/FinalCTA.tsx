...
const FinalCTA = () => {
  ...
  const ctaSubtitle = getSetting("homepage_final_cta_subtitle", "From freelancer to registered business in India. Company registration, GST, custom AI setups, and compliance. We handle it all.");
