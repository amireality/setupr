...
const Skeleton = ({
  ...
  return (
    <div
      className={cn(
        "flex flex-1 w-full h-full min-h-[80px] rounded-xl bg-gradient-to-br border border-border/20 relative overflow-hidden",
        gradients[variant]
      )}
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-3">
        <span className="font-display text-lg md:text-xl lg:text-2xl font-bold text-foreground mb-1">
          {title}
        </span>
    ...
    <section id="journey-cards" className="py-12 md:py-28 relative bg-background">
      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="max-w-5xl mx-auto">
          {/* Bento Grid Layout: 
              Row 1: [Heading - 1col] [Dream It Card - 1col]
              Row 2: [Own It Card - 1col] [Grow It Card - 2col]
          */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
            ...
            {/* Dream It Card - Same size as Own It */}
            <motion.div
